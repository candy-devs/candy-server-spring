...
public class QCaBoardEntity extends EntityPathBase<CaBoardEntity> {
    ...
    private static final long serialVersionUID = -2054224983L;
    ...
    public final ListPath<candy.server.domains.article.entity.CaArticleEntity, candy.server.domains.article.entity.QCaArticleEntity> caArticleEntityList = this.<candy.server.domains.article.entity.CaArticleEntity, candy.server.domains.article.entity.QCaArticleEntity>createList("caArticleEntityList", candy.server.domains.article.entity.CaArticleEntity.class, candy.server.domains.article.entity.QCaArticleEntity.class, PathInits.DIRECT2);

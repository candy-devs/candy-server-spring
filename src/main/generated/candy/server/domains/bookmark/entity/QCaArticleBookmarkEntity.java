...
public class QCaArticleBookmarkEntity extends EntityPathBase<CaArticleBookmarkEntity> {
    ...
    private static final long serialVersionUID = 1028571229L;
    ...
    public final candy.server.domains.article.entity.QCaArticleEntity articleId;
    ...
    public QCaArticleBookmarkEntity(Class<? extends CaArticleBookmarkEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.articleId = inits.isInitialized("articleId") ? new candy.server.domains.article.entity.QCaArticleEntity(forProperty("articleId"), inits.get("articleId")) : null;

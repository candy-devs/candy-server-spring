...
public class QCaAccountEntity extends EntityPathBase<CaAccountEntity> {
    ...
    public final NumberPath<Long> accountUserCandyCnt = createNumber("accountUserCandyCnt", Long.class);

    public final candy.server.domain.user.entity.QCaUserEntity caUserEntity;
    ...
    public QCaAccountEntity(Class<? extends CaAccountEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.caUserEntity = inits.isInitialized("caUserEntity") ? new candy.server.domain.user.entity.QCaUserEntity(forProperty("caUserEntity"), inits.get("caUserEntity")) : null;
    }
